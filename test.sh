...
# goto-instrument --function-pointer-restrictions-file restrictions.json $HARNESS/a.out $HARNESS/b.out 2>&1 | tee $HARNESS/goto-instrument.log
...
goto-instrument --reachability-slice $HARNESS/d.out $HARNESS/e.out 2>&1 | tee $HARNESS/slice.log
# goto-instrument --dump-c $HARNESS/e.out $HARNESS/e.c
# echo "Running CBMC"
