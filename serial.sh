...
goto-instrument --function-pointer-restrictions-file /home/ubuntu/firecracker/edit-rest.json $HARNESS/a.out $HARNESS/b.out 2>&1 | tee $HARNESS/goto-instrument.log
